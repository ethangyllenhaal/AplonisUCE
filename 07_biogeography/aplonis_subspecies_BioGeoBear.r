...
# Working directory
setwd('/Users/pachycephala/Dropbox/__WORK/1.MANUSCRIPTS/Aplonis-Ethan/BIOGEOBEARS/subspecies-level')
extdata_dir = np(system.file("extdata", package="BioGeoBEARS"))
# Add the name of the tree here, later lines just print it out
treename = 'aplonis_mito_time75-tree_logcombined.newick'
moref(treename)
...
# Set up PDF
pdffn = "aplonis_ultra_decVdecj_time75.pdf"
